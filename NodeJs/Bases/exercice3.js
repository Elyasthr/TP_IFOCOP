/**
  ...
  --> const est un mot-clé qui joue le même rôle que var. Il permet de créer une
      ...
      qu'une variable crée avec const ne peut pas être modifiée par la suite.
      Ici on utilise const plutôt que var car on ne va (certainement) pas
      modifier le contenu de l'objet FileSystem. Il s'agit donc la d'une bonne
...
**/
        ...
        /*modulefs.writeFile('fichiertexte','Ceci est un message écrit par Node JS', function(e){
          console.log(e);
        });*/
...
**/
    ...
    var monModule = require('exercice3-module');
