/**
  ...
  SI on fourni le CHEMIN COMPLET vers le fichier contenant le module à charger,
  elle essaie de charger le module.

  SINON SI on ne fourni que le nom du fichier à charger (sans préciser le
  chemin),
...
**/
    ...
    //module.require('exercice2-module'); ou simplement
...
**/
    var modulesec = require('exercice2-module');
...
**/
  ...
  for(var i = 0; i < modulesec.tableau.length; i++){    
      maphrase = maphrase + modulesec.tableau[i] + ' ';
  }

  console.log(maphrase);

  modulesec.obj.maCouleur();
/**
